...
namespace Sayiad.Data.Migrations
{
    ...
    [Migration("20260611010147_AddBirthdateRefreshTokenHashAuditLog")]
    partial class AddBirthdateRefreshTokenHashAuditLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sayiad.Data.Models.AuctionRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ResultingAuctionId")
                        .HasColumnType("int");

                    b.Property<int?>("ReviewedByAuctioneerId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ResultingAuctionId");

                    b.HasIndex("ReviewedByAuctioneerId");

                    b.ToTable("AuctionRequests");
                });

            modelBuilder.Entity("Sayiad.Data.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sayiad.Data.Models.Wallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sayiad.Data.Models.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sayiad.Data.Models.AuctionRequest", b =>
                {
                    b.HasOne("Sayiad.Data.Models.User", "Fisherman")
                        .WithMany()
                        .HasForeignKey("FishermanId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Sayiad.Data.Models.Auction", "ResultingAuction")
                        .WithMany()
                        .HasForeignKey("ResultingAuctionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Sayiad.Data.Models.User", "ReviewedByAuctioneer")
                        .WithMany()
                        .HasForeignKey("ReviewedByAuctioneerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("Fisherman");

                    b.Navigation("ResultingAuction");

                    b.Navigation("ReviewedByAuctioneer");
                });
            ...
            modelBuilder.Entity("Sayiad.Data.Models.Wallet", b =>
                {
                    b.HasOne("Sayiad.Data.Models.User", "User")
                        .WithOne("Wallet")
                        .HasForeignKey("Sayiad.Data.Models.Wallet", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Sayiad.Data.Models.WalletTransaction", b =>
                {
                    b.HasOne("Sayiad.Data.Models.Wallet", "Wallet")
                        .WithMany("Transactions")
